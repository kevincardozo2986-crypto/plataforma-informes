...
class LoginWindow(QWidget):
    ...
    def _create_form_panel(self):
        ...
        campus_logo = QLabel(objectName="loginCampusLogo")
        campus_logo.setPixmap(QPixmap(str(Path(__file__).parent / "assets" / "campus-virtual-logo.png")).scaled(280, 82, Qt.KeepAspectRatio, Qt.SmoothTransformation))
        campus_logo.setAlignment(Qt.AlignCenter)
        campus_logo.setFixedHeight(86)
        campus_logo.setAccessibleName("Universidad Santo Tomás · Campus Virtual")
